...
def main():
    ...
    # sorted_char_count = sort_chars_by_count(character_count)
    # print(f"Sorted character count: {sorted_char_count}")
    alpha_dict = remove_non_alpha_chars(character_count)
    # print(alpha_dict)
    sorted_alpha_char_count = sort_chars_by_count(alpha_dict)
    # print(f"Sorted alpha character count: {sorted_alpha_char_count}")
